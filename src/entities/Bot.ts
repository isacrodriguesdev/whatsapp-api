...
export class Bot {
  ...
  constructor(bot: INewBot) {
    ...
    this.rule_trasmission_max_send_users_by_day = assign(
      bot.rule_trasmission_max_send_users_by_day,
      1000
    );
    this.rule_trasmission_max_send_messages_by_day = assign(
      bot.rule_trasmission_max_send_messages_by_day,
      2
    );
